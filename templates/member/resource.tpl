    ...
    <div class="fbneirong">
      <form class="am-form" id="resource_form" action="/service.php?business=dc&controller=member_resource&action=edit_submit" method="post">
        <div class="am-form-group am-cf">
          ...
          <div class="you">
            <input type="text" name="service_id" class="am-input-sm" id="doc-ipt-text-1" placeholder="请输入服务id">
          </div>
        </div>        
        <div class="am-form-group am-cf">
        ...
        <div class="am-form-group am-cf">
          ...
          <div class="you">
            <textarea name="resource_content" id="resource_content" class="" rows="30" id="doc-ta-1"></textarea>
          </div>
        </div> 
        <div class="am-form-group am-cf">
